...
<html><head>
  ...
  <script>window.onload=()=>{setTimeout(()=>window.print(),700)}<\/script>
    ...
    return (
        <div className="min-h-screen relative" style={{ padding: 'max(1rem, env(safe-area-inset-top)) max(1rem, env(safe-area-inset-right)) max(5rem, env(safe-area-inset-bottom)) max(1rem, env(safe-area-inset-left))' }}>
